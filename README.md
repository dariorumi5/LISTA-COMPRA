...
2. Ejecuta la clase `GestorListaCompra` con clic derecho → `Run As → Java Application`.

CÓMO EJECUTAR LAS PRUEBAS: 
1. Abre la clase GestorListaCompraTest.
2. Clic derecho → Run As → JUnit Test.ebas
